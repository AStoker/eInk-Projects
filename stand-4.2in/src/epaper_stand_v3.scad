...
// ports
chg_z = 30.0;                                     // bq24074 USB-C, +X wall
chg_y0 = 6.0; chg_y1 = 11.6;
...
module usb_cut(){
    // charge port (bq24074) through the +X wall
    translate([cav_x1-1.2, chg_y0, chg_z-usb_w/2])
        cube([W/2 - cav_x1 + 2.2, chg_y1-chg_y0, usb_w]);
...
module mock_board(){
    ...
    color("#c9ccd1") translate([proto_x1+0.4, proto_face-2.5-1.6-3.2, chg_z])
        xzext(3.2) square([0.8, 9],center=true);
    // LiPo cell
